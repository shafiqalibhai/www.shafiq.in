...
1. **Understand Market Conditions:**
   ...
   - Analyse any significant news or events affecting the market.
...
4. **Technical Analysis:**
   - Analyse price charts using technical indicators such as moving averages, RSI (Relative Strength Index), MACD (Moving Average Convergence Divergence), and Bollinger Bands.
