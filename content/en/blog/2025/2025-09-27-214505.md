...
| Phase F: Migration Planning | Sprint tasks for roadmap prioritisation |
...
|--------------|--------------|--------------|
| Enterprise Architect | Product Owner (or Scrum Team Architect) | Prioritises architecture backlog |
